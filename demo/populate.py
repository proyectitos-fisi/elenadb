...
run_query("creame tabla estudiantes { id int @id, codigo char(8) @unique, nombre char(255), tipo_documento char(4), documento char(13), creditos int, correo char(255), es_tercio bool, } pe")
